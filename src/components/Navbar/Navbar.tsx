...
function Navbar({ user }: Props) {
  ...
  return (
    <header className='z-10 w-full fixed flex-grow box-border px-5 h-12 bg-[#242424] inline-flex justify-between items-center border border-[#424242]'>
        ...
        <DropdownButton
          ...
          iconLeft={
            <svg
              ...
              strokeWidth={1.5}
              stroke='currentColor'
              className='w-6 h-6 mr-4 text-[#b8b8b8]'
            >
              <path
                strokeLinecap='round'
      ...
      <div className='lg:flex hidden flex-row justify-center items-center'>
        <Button iconButton>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
        ...
        <div className='border-l-2 border-[#424242] h-8' />
      </div>
      <Button iconButton>
        <svg
          xmlns='http://www.w3.org/2000/svg'
